...
var QueryInfo = function() {
  ...
  QueryInfo2.prototype.markResult = function(result, document, options, cacheWriteBehavior) {
    ...
    if ("incremental" in result && isNonEmptyArray(result.incremental)) {
      ...
      result.incremental.forEach(function(_a4) {
        var data = _a4.data, path = _a4.path, errors = _a4.errors;
        for (var i = path.length - 1; i >= 0; --i) {
          var key = path[i];
...
function useMutation(mutation, options) {
  ...
  var execute2 = (0, import_react4.useCallback)(function(executeOptions) {
    ...
    var _a5 = ref.current, client2 = _a5.client, options2 = _a5.options, mutation2 = _a5.mutation;
    ...
    return client2.mutate(clientOptions).then(function(response) {
      ...
      (_b = (_a6 = ref.current.options) === null || _a6 === void 0 ? void 0 : _a6.onCompleted) === null || _b === void 0 ? void 0 : _b.call(_a6, response.data, clientOptions);
      ...
      if (((_a6 = ref.current.options) === null || _a6 === void 0 ? void 0 : _a6.onError) || clientOptions.onError) {
